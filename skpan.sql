...
CREATE TABLE `sk_order` (
  ...
  `profit_uid` int(11) NOT NULL DEFAULT '0' COMMENT '收益用户ID',
...
INSERT INTO `sk_order` VALUES (1,5,'VIP_202109140419288B01F7E34D','','alipay',0,2.00,30,1631564368,0,0);
...
INSERT INTO `sk_profit` VALUES (1,5,90,5,1,2,0,0,0.00,0.00,1631542710),(2,5,91,12,2,6,0,0,0.00,0.00,1631542900),(3,5,92,74,1,0,0,0,0.00,0.00,1631545469),(4,5,90,6,2,6,0,0,0.00,0.00,1631422109),(5,5,91,49,0,0,0,0,0.00,0.00,1631549201),(6,5,90,69,0,0,0,0,0.00,0.00,1631549214),(7,5,92,202,1,0,0,0,0.00,0.00,1631553147),(8,5,48,0,0,4,0,0,0.00,0.00,1631553201);
