...
INSERT INTO `sk_groups` VALUES (1,'管理员',1,1073741824,'',1,1),(2,'游客',1,0,'5',0,1),(3,'普通用户',4,104857600,'20',1,1),(4,'VIP用户',1,209715200,'',1,0);
...
INSERT INTO `sk_order` VALUES (18,5,'VIP_202109281904568FD7FCB859','','alipay',118,2.00,30,1632827096,0,0);
...
CREATE TABLE `sk_policys` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='储存策略';
...
INSERT INTO `sk_policys` VALUES (1,'默认存储','local','',2097152,'{\"save_dir\":\"\\/default\\/\",\"access_token\":\"\",\"server_uri\":\"\"}'),(3,'远程服务器一','remote','',1073741824,'{\"save_dir\":\"\\/uploads\\/\",\"access_token\":\"asdasfasfasfasfasfa\",\"server_uri\":\"http:\\/\\/tp.com:8080\\/server\\/index.php\"}'),(4,'测试阿里云','aliyunoss','',0,'{\"save_dir\":\"\\/uploads\\/\",\"endpoint\":\"oss-cn-hangzhou.aliyuncs.com\",\"bucket\":\"skpan-store-1\",\"access_key\":\"LTAI5tRkL7PfE5YrYnK5i5Vp\",\"access_secret\":\"LSRzPi3vGLsOdKh6Q48Wl89nTp6O9R\"}');
...
CREATE TABLE `sk_profit` (
  ...
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='收益记录';
...
INSERT INTO `sk_profit` VALUES (1,5,90,5,1,2,0,0,0.00,0.00,1631542710),(2,5,91,12,2,6,0,0,0.00,0.00,1631542900),(3,5,92,102,1,0,0,0,0.00,0.00,1631545469),(4,5,90,6,2,6,0,0,0.00,0.00,1631422109),(5,5,91,49,0,0,0,0,0.00,0.00,1631549201),(6,5,90,69,0,0,0,0,0.00,0.00,1631549214),(7,5,92,230,1,0,0,0,0.00,0.00,1631553147),(8,5,48,0,0,4,0,0,0.00,0.00,1631553201),(9,5,95,2,0,0,0,0,0.00,0.00,1631576957),(10,5,133,2,0,0,0,0,0.00,0.00,1631579839),(11,5,134,2,0,0,0,0,0.00,0.00,1631591496),(12,5,137,6,5,0,0,0,0.00,0.00,1631624501),(13,5,138,4,4,0,0,0,0.00,0.00,1631624563),(14,5,139,3,2,0,0,0,0.00,0.00,1631624691),(15,5,140,24,8,0,0,0,0.00,0.00,1631624735),(16,5,141,62,130,0,0,0,0.00,0.00,1631626904),(17,5,142,3,13,0,0,0,0.00,0.00,1631635076),(18,5,142,1,6,0,0,0,0.00,0.00,1631635371),(19,5,141,15,30,0,0,0,0.00,0.00,1631635502),(20,5,150,3,1,0,0,0,0.00,0.00,1631652994),(21,5,150,2,0,0,0,0,0.00,0.00,1632748735),(22,5,151,4,5,0,0,0,0.00,0.00,1632748916),(23,5,151,2,3,0,0,0,0.00,0.00,1632811229),(24,5,152,2,0,0,0,0,0.00,0.00,1632812038),(25,5,158,8,2,0,0,0,0.00,0.00,1632822399),(26,5,159,6,2,0,0,0,0.00,0.00,1632823357),(27,5,161,15,4,0,0,0,0.00,0.00,1632825301),(28,5,162,5,5,0,0,0,0.00,0.00,1632829311);
...
CREATE TABLE `sk_shares` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='分享表';
...
CREATE TABLE `sk_stores` (
  ...
  `delete_time` int(11) DEFAULT NULL COMMENT '软删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=153 DEFAULT CHARSET=utf8 COMMENT='储存文件';
...
INSERT INTO `sk_stores` VALUES (159,5,116,'20211632811688196.docx','//default/20210928/5/file_6152e83bf23001632823355.docx',727523,'','','docx',8,1,2,6,'',NULL,1632823355,1632823355,NULL),(160,5,117,'phpstudyV8使用说明.txt','/default/20210928/5/file_6152e8e6cf8501632823526.txt',535,'','','txt',8,1,0,0,'',NULL,1632823526,1632823526,NULL),(161,5,118,'DQInstaller_v5.3.3.911.exe','/default/20210928/5/file_6152efc24b3201632825282.exe',8988760,'','','exe',8,1,4,15,'',NULL,1632825282,1632825282,NULL),(162,5,119,'DQInstaller_v5.3.3.911.exe','/uploads/20210928/5/file_6152ff69825f01632829289.exe',8988760,'','','exe',8,4,5,5,'',NULL,1632829308,1632829308,NULL);
