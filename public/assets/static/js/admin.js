;(function () {
    ...
    if (ajaxForm_list.length) {
        ...
        //设置td标签点击也选中
        $("td").click(function(){
            if($(this).find("input").length && $(this).find("input").hasClass("js-check")){
                        ...
                        $form.ajaxSubmit({
                            ...
                            success: function (data, statusText, xhr, $form) {
                                ...
                                if (data.code == 1) {
                                    ...
                                    parent.layer.msg(data.msg, {time:800, icon:1, shift:4});
...
function reloadPage() {
    ...
    if (parent.layer.getFrameIndex(window.name)){
        return;
        var location  = parent.window.location;
        parent.location.href = location.pathname + location.search;
